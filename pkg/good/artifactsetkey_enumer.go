...
const (
	...
	_ArtifactSetKeyName_5      = ""
	_ArtifactSetKeyLowerName_5 = ""
)
...
var (
	...
	_ArtifactSetKeyIndex_5 = [...]uint16{0, 19, 31, 46, 58, 80, 89, 111, 130, 149, 162, 181, 199, 215, 227, 250, 270, 281, 296, 314, 326, 340, 374, 398, 415, 442, 455}
)
